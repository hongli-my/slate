(() => {
  ...
  [
    ...
    core_default.registerLanguage(entry[0], entry[1]);
  });
  window.hljs = core_default;
  window.__hljsReady = true;
  if (window.__hljsResolve) window.__hljsResolve(core_default);
})();
//# sourceMappingURL=hljs.bundle.js.map
